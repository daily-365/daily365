	...
	<form id="replyForm" method="post">
		<c:if test="${userId ne null }">
			...
			<c:if test="${userId eq null }">
				<div class="col-4">
					<button type="button" class="btn btn-outline-primary" onclick="javascript:alert('로그인 후 이용가능합니다'); location.href='/member/login';">글쓰기</button>
				</div>
				<br><br>
			</c:if>
			<br><br>
		...
		<div class="row">
			<c:if test="${userId ne null and replyList.rno ne 0 and replyList.writer ne userId }">
				<div class="col-2">
