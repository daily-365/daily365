...
<body class="container-fluid">
	...
	<br><br>
		...
		<div class="col-4">
			<c:choose>
				<c:when test="${userId eq read.writer }">
					<button type="button" class="btn btn-primary " onclick="javascript:location.href='/'" >목록으로</button>
					<button type="button" class="btn btn-warning" id="updateBtn">수정</button>
					<button type="button" class="btn btn-danger " id="deleteBtn">삭제</button>
					<br><br>
				</c:when>
				<c:otherwise>
					<button type="button" class="btn btn-primary returnIndex" onclick="javascript:location.href='/'" >목록으로</button>
					<br><br>
				</c:otherwise>
			</c:choose>
		</div>
